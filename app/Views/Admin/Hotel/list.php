        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="mb-3 row justify-content-between px-3">
                    ...
                    <a href="<?= base_url() ?>/adminuser/hotel/add" class="btn btn-primary">Tambah Hotel</a>
                </div>
                <hr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-button-action">
                                                ...
                                                <a href="<?= base_url() ?>/adminuser/paketumrah/<?= $p['id'] ?>" class="btn btn-primary p-2 ms-1">Edit <i class="fas fa-edit"></i></a>
                                            </div>
                                        </td>
                                    </tr>
                                    <?php $no++ ?>
